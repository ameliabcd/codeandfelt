const StorySection = () => {
  return (
    <>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-serif text-5xl font-bold text-gray-800 mb-6">Our Story</h2>
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                This website was born from the intersection of two passions: data science and fiber arts. 
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-pink-50 to-blue-50 rounded-3xl p-12">
