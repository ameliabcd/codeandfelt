...
export function generateSierpinski(width, height, iterations = 6) {
  ...
  // Define triangle vertices - use larger area (smaller margins for bigger triangle)
  // Top vertex - centered horizontally, near top
  const margin = Math.max(5, Math.min(width, height) * 0.05); // 5% margin or at least 5px
